...
export const LoginView: React.FC<LoginViewProps> = ({ users, onLogin }) => {
  ...
  return (
    <div className="h-screen w-screen bg-[#fffef9] flex items-center justify-center p-4 md:p-8 relative overflow-hidden fixed inset-0 z-[100]">
      ...
      <div className="w-full max-w-xl bg-white/80 backdrop-blur-2xl rounded-[4rem] shadow-[0_40px_100px_-20px_rgba(255,184,95,0.2)] border-2 border-white/60 overflow-hidden relative z-10 flex flex-col scale-95 md:scale-100 transition-all duration-700">
        ...
        <div className="pt-12 pb-8 text-center bg-white/40">
          ...
          <p className="text-brand-orange font-black uppercase text-xs tracking-[0.5em]">Management System</p>
        </div>
